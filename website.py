...
print("DDoS T00LS By ~iYonnn")
print("[ ! ] Info: This tools have a fake ip")
print("[ + ] But for a safety i req u to use Super Vpn.")
...
def run():
    ...
    while True:
        try:
            ...
            print(f"Attack Ip/Url : {ip} || Port {port} || Packet Send : {times}")
            s.close()
